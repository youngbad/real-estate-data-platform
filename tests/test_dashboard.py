...
from src.dashboard.app import get_engine, require_data

@patch('src.dashboard.app.create_sql_server_engine')
...
@patch('src.dashboard.app.pd.read_sql')
@patch('src.dashboard.app.get_engine')
...
@patch('src.dashboard.app.pd.read_sql')
@patch('src.dashboard.app.get_engine')
@patch('src.dashboard.app.st.error')
@patch('src.dashboard.app.st.stop')
